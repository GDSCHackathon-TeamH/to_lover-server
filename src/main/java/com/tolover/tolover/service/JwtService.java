...
import static com.tolover.tolover.exception.BaseResponseStatus.*;
...
public class JwtService {
    ...
    private static final long ACCESS_TOKEN_EXPIRE_TIME = 1000 * 60 * 60 * 24 * 60;  // 30일 (개발 단계) -> 최종 2일 변경 예정
    private static final long REFRESH_TOKEN_EXPIRE_TIME = 1000 * 60 * 60 * 24 * 60;  // 30일 (개발 단계) -> 최종 2일 변경 예정
